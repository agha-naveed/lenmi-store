...
export default function ProductCard() {
  return (
    <div>
        <div className='bg-white border border-gray-400 group rounded-lg w-52 h-[310px] p-2 grid gap-3'>
        ...
        <button className='bg-slate-800 text-white h-9 w-full'>Add to Cart</button>
    </div>
  )
}
