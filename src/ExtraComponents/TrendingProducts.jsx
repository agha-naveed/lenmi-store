  ...
  return (
    <div className='w-[380px] h-full rounded-[22px] p-8 bg-lightGray'>
        <div className='w-full justify-items-center grid gap-5'>
            <h3 className='text-2xl text-left w-full font-muli-bold tracking-[-2px] text-slate-800'>Trending Products</h3>
            ...
            <div className='w-full h-auto rounded-[22px] bg-white'>
                <div className='p-6 grid gap-5'>
                    ...
                    <Link>
                        ...
                        <span className='text-black w-full flex gap-[2px] py-2 items-end justify-center font-muli-semibold'>
                            PKR
                    ...
                    <div className='flex gap-5'>
                        ...
                        <Link>
                            ...
                            <span className='text-black w-full text-[14px] py-2 flex gap-[2px] items-end justify-center font-muli-semibold'>
                                PKR
                                <span className='text-[20px] relative top-[2px]'>1,116</span>
                                <span className='bg-slate-800 text-white ml-[3px] relative top-[-3px] text-[12px] px-1 rounded-[4px] '>-72%</span>
                            </span>
                        </Link>
