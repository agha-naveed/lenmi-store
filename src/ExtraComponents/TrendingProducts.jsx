...
export default function TrendingProducts() {
  return (
    <div className='w-56 h-full border border-black rounded-lg p-2'>
        <div className='w-full justify-items-center grid gap-2'>
            <div className='w-[210px] h-[200px] p-2 group transition_2 rounded-lg overflow-hidden border relative cursor-pointer'>
